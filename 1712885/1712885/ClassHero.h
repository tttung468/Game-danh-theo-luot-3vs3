...
public:
	...
	virtual void tuongSinh(ClassHero* hero);			//tương sinh với hero
	virtual void tuongKhac(ClassHero* &hero, char team);//tương khắc với hero, team = 'S' hoặc 'D' (chọn hero theo đồng minh hoặc địch)
};
